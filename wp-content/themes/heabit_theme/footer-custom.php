<?php
/**
 * The template for displaying the custom footer
 *
        ...
        <ul class="socials">
            ...
            <li>
                <a href="https://github.com/oleksandrkartashev/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <svg xmlns="http://www.w3.org/2000/svg" height="800px" width="800px" version="1.1" fill="none" viewBox="-143 145 512 512">
                        <g>
